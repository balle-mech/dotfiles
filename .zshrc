...
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/fukunagaatsushi/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/fukunagaatsushi/anaconda3/etc/profile.d/conda.sh" ]; then
# . "/Users/fukunagaatsushi/anaconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
    else
